...
const char *help[] = {
    ...
    "  'mycall c' to set MYCALL where c is callsign.",
    "  'netcall add c' to add net call where c is callsign.",
    "  'netcall del c' to delete net call where c is callsign.",
    ...
    "  'ping c n', where c is callsign and n is number of repeats.",
    "",
    ...
    "    call is destination callsign, fl is message flag (R,F,S",
    ...
    "    destination callsign, 'ri' to read the ARIM configuration",
    "    file. Press 'q' to quit.",
    "",
    "ARQ mode commands and queries:",
    "  'conn c n' to connect where c is callsign of remote station",
    ...
    "    fn is file name, call is destination callsign, fl is message",
