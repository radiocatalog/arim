...
const char *help[] = {
    ...
    "    is an optional ARQBW specifier. This can be one of: 200, 500,",
    "    2500 or 'any'. If 'any', all possible ARQBW settings are",
    "    tried in succession. This is useful if the ARQBW setting of",
    "    the remote station is unknown.",
